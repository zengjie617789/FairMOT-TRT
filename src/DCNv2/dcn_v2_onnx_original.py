...
class _DCNv2(Function):
    ...
    def symbolic(g, input, offset, mask, weight, bias, stride, padding, dilation, deformable_groups):
        return g.op("custom_domain::DCNv2", input, offset, mask, weight, bias, name_s="DCNv2", info_s=json.dumps({
            "dilation": dilation,
            "padding": padding,
            "stride": stride,
    ...
    # @staticmethod
    # def symbolic(g, input, offset, mask, weight, bias, stride, padding, dilation, deformable_groups):
    #     return g.op("dcnv2::DCNv2_TRT", input, offset, mask, weight, bias, name_s="DCNv2_TRT", info_s=json.dumps({
    #         "dilation": dilation,
    #         "padding": padding,
    #         "stride": stride,
    #         "deformable_groups": deformable_groups
