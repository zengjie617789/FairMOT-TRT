...
class MotLoss(torch.nn.Module):
    def __init__(self, opt):
        ...
        self.s_det = nn.Parameter(-1.3126 * torch.ones(1))
        # self.s_id = nn.Parameter(-0.4201 *torch.ones(1))
        self.s_id = nn.Parameter(1.6170 *torch.ones(1))
    ...
    def forward(self, outputs, batch):
        ...
        det_loss = opt.hm_weight * hm_loss + opt.wh_weight * wh_loss + opt.off_weight * off_loss  #hm_weight:1 ; wh_weight: 0.1; off_weight: 1
