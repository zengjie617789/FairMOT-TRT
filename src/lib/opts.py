...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--val_mot16', default=True, help='val mot16 or mot15')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/awifi/zzzj/projects/datasets')
    ...
    self.parser.add_argument('--ltrb', type=bool, default=True,
...
# normMean = [0.4725996  0.47627005 0.45940742]
# normstd = [0.23685737 0.23647648 0.22925246]
  ...
  def init(self, args=''):
    ...
    custom_dataset_info = {
      'mot': {'default_resolution': [608, 1088], 'num_classes': 1,
                'mean': [0.452, 0.459, 0.456 ], 'std': [0.241, 0.245, 0.241],
                'dataset': 'jde', 'nID': 14455},
    }
    class Struct:
    ...
    dataset = Struct(custom_dataset_info[opt.task])
